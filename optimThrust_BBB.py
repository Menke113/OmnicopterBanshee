...
def optim_thrust(T, max_thrusts, xp):
    ...
    k_t = max_thrusts[0]/(w_max_2306**2)

    # xp_quadratic_squared_times_kt = [x**2 * np.sign(x) * k_t for x in xp_quadratic]

    # xp = [np.random.uniform(-1.0,1.0) * max_thrust_motor_2306, np.random.uniform(-1.0,1.0) * max_thrust_motor_2306, np.random.uniform(-1.0,1.0) * max_thrust_motor_2306, np.random.uniform(-1.0,1.0) * max_thrust_motor_2306, 
    # np.random.uniform(-1.0,1.0) * max_thrust_motor_2806, np.random.uniform(-1.0,1.0) * max_thrust_motor_2806, np.random.uniform(-1.0,1.0) * max_thrust_motor_2806, np.random.uniform(-1.0,1.0) * max_thrust_motor_2806]
